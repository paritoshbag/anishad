...
export default function ListTest() {
    const { data, loading, mutate } = useDataFetching('/api/admin/addtest');
                    ...
                    <Stack flexDir={'row'} gap={2}>
                        <Button
                            ...
                            onClick={() => {
                                ...
                                // EditTest(row.id)
                                router.push(`/dashboard/add-test/list/edit/${row.id}`)
                            }}
            ...
            <Sidebar>
                <Stack>
                    <Stack flexDir={'row'}>
                        ...
                        />
                        <Button colorScheme='green' onClick={() => router.push('/dashboard/add-test')}>New</Button>
                    </Stack>
                    {loading ? (
                        <div>Loading...</div>
                    ) : (
